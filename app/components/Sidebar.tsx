      ...
      <div className="relative z-30">
        ...
        >
          ...
          <div className="flex flex-col p-4 space-y-6 bg-purple-500 rounded-lg">
            ...
            <p className="hover:underline hover:text-blue-300 transition-colors duration-300 shadow-lg hover:shadow-xl rounded-sm p-3">
              <Link
                href={"/"}
                className="visited:text-white rounded-md"
